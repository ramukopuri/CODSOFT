...
if __name__ == "__main__":  
    ...
    # setting the background color to #00FF00 
    guiWindow.configure(bg = "#00FF00")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#00FF00")  
    functions_frame = tk.Frame(guiWindow, bg = "#00FF00")  
    listbox_frame = tk.Frame(guiWindow, bg = "#00FF00")  
